...
For each feature x (a column in your data matrix), use scaling

Gradient Descent. Implement gradient descent to find a regression model. Initialize your β’s to zero. 
